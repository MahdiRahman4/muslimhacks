...
const contactEmails = [
  { key: 'generalInquiries', email: 'info@muslimhacks.ca' },
  { key: 'sponsorship', email: 'sponsors@muslimhacksoutreach.ca' },
];
            ...
            <ul className="space-y-2">
              {footerLinks.map((item) => (
                <li key={item.href}>
                  ...
                  >
                    {t(`footerSection.links.${item.key}`)}
                  </a>
                </li>
              ))}
            </ul>
